...
class NewsCoverMigration extends BaseMigration {
  ...
  public function __construct($wpTablePrefix, $spipDbConnection, $telaDbConnection, $wpDbConnection, $wordpressDir) {
    parent::__construct($wpTablePrefix, $spipDbConnection, $telaDbConnection, $wpDbConnection);
    $this->wordpress_dir = $wordpressDir;
  }
  ...
  */
  public function migrate() {
    ...
    if (!file_exists($wordpressDir . '/IMG')) {
