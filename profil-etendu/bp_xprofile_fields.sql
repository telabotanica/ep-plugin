-- phpMyAdmin SQL Dump
-- Généré le :  Jeu 02 Février 2017 à 13:59
...
(2, 3, 0, 'datebox', 'Date de naissance', '', 0, 0, 0, 0, '', 1),
(3, 1, 0, 'selectbox', 'Pays', '', 1, 0, 4, 0, 'custom', 1),
(4, 1, 0, 'textbox', 'Ville', '', 1, 0, 5, 0, '', 1),
(463, 1, 3, 'option', 'Martinique', '', 0, 0, 0, 145, '', 1),
(462, 1, 3, 'option', 'Maroc', '', 0, 0, 0, 144, '', 1),
(9, 1, 0, 'textbox', 'Nom', '', 1, 0, 2, 0, '', 1),
(10, 1, 0, 'textbox', 'Prénom', '', 0, 0, 3, 0, '', 1),
(461, 1, 3, 'option', 'Malte', '', 0, 0, 0, 143, '', 1),
(12, 2, 0, 'radio', 'Expérience botanique', '', 1, 0, 0, 0, 'custom', 1),
(68, 2, 61, 'option', 'yyy', '', 0, 0, 0, 2, '', 1),
(70, 1, 3, 'option', 'Afghanistan', '', 0, 0, 0, 1, '', 1),
(63, 2, 0, 'textbox', 'Espèce d\\\'intérêt', '', 0, 0, 3, 0, 'custom', 1),
(67, 2, 61, 'option', 'xxx', '', 0, 0, 0, 1, '', 1),
(61, 2, 0, 'multiselectbox', 'Zones géographiques d\\\\\\\'intérêt', '', 0, 0, 2, 0, 'custom', 1),
(22, 2, 12, 'option', 'Débutant', '', 0, 0, 0, 1, '', 1),
(23, 2, 12, 'option', 'Ayant une bonne pratique', '', 0, 0, 0, 2, '', 1),
(24, 2, 12, 'option', 'Confirmé', '', 0, 0, 0, 3, '', 1),
(25, 2, 12, 'option', 'Ne se prononce pas', '', 0, 1, 0, 4, '', 1),
(26, 3, 0, 'selectbox', 'Métier', '', 0, 0, 3, 0, 'custom', 1),
(27, 3, 26, 'option', 'agriculteur', '', 0, 0, 0, 1, '', 1),
(28, 3, 26, 'option', 'jardinier', '', 0, 0, 0, 2, '', 1),
(29, 3, 26, 'option', 'forestier', '', 0, 0, 0, 3, '', 1),
(30, 3, 26, 'option', 'apiculteur', '', 0, 0, 0, 4, '', 1),
(31, 3, 26, 'option', 'écolier (primaire, secondaire)', '', 0, 0, 0, 5, '', 1),
(32, 3, 26, 'option', 'étudiant (biologie, environnement, etc.)', '', 0, 0, 0, 6, '', 1),
(33, 3, 26, 'option', 'enseignant (primaire, secondaire)', '', 0, 0, 0, 7, '', 1),
(34, 3, 26, 'option', 'chercheur / enseignant 3ème cycle', '', 0, 0, 0, 8, '', 1),
(35, 3, 26, 'option', 'conservateur (musée, herbier)', '', 0, 0, 0, 9, '', 1),
(36, 3, 26, 'option', 'formateur professionnel', '', 0, 0, 0, 10, '', 1),
(37, 3, 26, 'option', 'animateur (culture, nature, environnement, etc.)', '', 0, 0, 0, 11, '', 1),
(38, 3, 26, 'option', 'gestionnaire (espaces verts, parcs, etc.)', '', 0, 0, 0, 12, '', 1),
(39, 3, 26, 'option', 'écologue / botaniste de terrain (conservatoire botanique, bureau d’étude, etc.)', '', 0, 0, 0, 13, '', 1),
(40, 3, 26, 'option', 'journalistes / chargé de communication', '', 0, 0, 0, 14, '', 1),
(41, 3, 26, 'option', 'bénévole associatif', '', 0, 0, 0, 15, '', 1),
(42, 3, 26, 'option', 'salarié associatif', '', 0, 0, 0, 16, '', 1),
(43, 3, 26, 'option', 'fonctionnaire (collectivité territoriale / administration)', '', 0, 0, 0, 17, '', 1),
(44, 3, 26, 'option', 'retraité', '', 0, 0, 0, 18, '', 1),
(45, 3, 26, 'option', 'autre', '', 0, 0, 0, 19, '', 1),
...
(47, 1, 46, 'option', 'personnel', '', 0, 1, 0, 1, '', 1),
(48, 1, 46, 'option', 'professionnel', '', 0, 0, 0, 2, '', 1),
(49, 1, 46, 'option', 'structure', '', 0, 0, 0, 3, '', 1),
(50, 1, 0, 'textbox', 'Code postal', '', 0, 0, 6, 0, '', 1),
(69, 2, 0, 'textbox', 'Membre d\\\'une association naturaliste', '', 0, 0, 1, 0, '', 1),
(51, 1, 0, 'textbox', 'Adresse', 'Votre adresse ne sera pas communiquée mais nous est utile pour éditer les reçus fiscaux si vous nous faites un don.', 0, 0, 7, 0, '', 1),
(52, 3, 0, 'url', 'Site web', '', 0, 0, 1, 0, '', 1),
(53, 3, 0, 'textarea', 'Présentation', '', 0, 0, 2, 0, '', 1),
(54, 1, 0, 'checkbox', 'Inscription à la lettre d\\\'actualité', '', 0, 0, 8, 0, 'custom', 1),
(66, 1, 54, 'option', 'Je souhaite recevoir la lettre', '', 0, 0, 0, 1, '', 1),
(59, 1, 0, 'checkbox', 'Conditions d\\\'utilisations', 'Vous trouverez les conditions sur le <a href=\\"https://beta.tela-botanica.org/preprod/mentions-legales/#conditions-d-utilisation\\">site</a>', 1, 0, 9, 0, 'custom', 1),
(60, 1, 59, 'option', 'J\\\'accepte les conditions d\\\'utilisation', '', 0, 0, 0, 1, '', 1),
